...
// echo $url->createURL("http://www.google.com");
// $url->createURL("http://www.google.com");
// // $href = "http://www.google.ch";
// // print_r($href." ".$url->createURL($href)."\n");
// // $href = "https://www.google.ch";
// // print_r($href." ".$url->createURL($href)."\n");
// // $href = "httpas://www.google.ch";
// // print_r($href." ".$url->createURL($href)."\n");
...
// 	$gen = $url->createURL("http://www.google.com/{$i}");
// 	$times[$i] = microtime(true) - $start;
// 	if($times[$i] > $max){
// 		print_r("http://www.google.com/{$i}: ".$gen."\n");
// 		print_r("operation {$i} took: {$times[$i]}s\n\n");
// 	}
// 	$max = max($times[$i],$max);
// 	$min = min($times[$i],$min);
// }
...
// print_r("average: {$avg}s\n");
// print_r("total: {$total}s\n");
// print_r("max: {$max}s\n");
// print_r("min: {$min}s\n");
